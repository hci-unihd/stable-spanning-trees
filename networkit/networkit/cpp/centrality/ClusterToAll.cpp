...
#include <networkit/centrality/ClusterToAll.hpp>
...
ClusterToAll::ClusterToAll(const Graph& G, std::vector<node> cluster_centers) : Centrality(G, false, true), cluster_centers(cluster_centers) {

}


void ClusterToAll::run() {
