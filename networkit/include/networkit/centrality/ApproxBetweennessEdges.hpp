/*
 * ApproxBetweennessEdges.hpp
 *
 *  Created on: 09.04.2014
 *      Author: cls
 */

#ifndef NETWORKIT_CENTRALITY_APPROX_BETWEENNESS_EDGES_HPP_
#define NETWORKIT_CENTRALITY_APPROX_BETWEENNESS_EDGES_HPP_
 ...
 */
class ApproxBetweennessEdges final: public Centrality {
...
public:
     ...
     * @param   computeEdgeCentrality   personal update to allow the calculation of the edge centrality
     */
    ApproxBetweennessEdges(const Graph &G, double epsilon = 0.01, double delta = 0.1,
                      double universalConstant = 1.0, bool computeEdgeCentrality=false);
...
#endif // NETWORKIT_CENTRALITY_APPROX_BETWEENNESS_EDGES_HPP_
